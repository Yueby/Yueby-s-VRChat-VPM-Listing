            ...
            {
                {
                    ...
                    {
                        { "title_main_label", "穿衣工具" },
                        { "configure_avatar_label", "Avatar模型" },
                        { "configure_clothes_label", "衣服" },
                        { "configure_avatar_tip", "↑ 将Avatar模型对象拖到这里来。" },
                        { "configure_clothes_tip", "将衣服对象拖到这里来\t\t      ↑" },
                        { "configure_same_name_tip", "Avatar模型里有个衣服和当前要穿上的衣服重名，确定要穿上吗？" },
                        { "configure_sure_radio", "我确定！" },
                        { "configure_same_game_object_tip", "Avatar模型和衣服是同一个对象！" },
                        { "configure_bone_name_issue_tip", "发现衣服骨骼命名有问题！" },
                        { "configure_try_fix_button", "尝试修复" },
                        { "configure_armature_issue_tip", "Avatar模型或者衣服上的骨架未找到，请检查骨架名字是否正确！" },
                        { "configure_armature_none_bone_tip", "Avatar模型或者衣服骨架的底下没有其他骨骼！请检查！" },
                        { "configure_check_over_tip", "衣服检查良好，可以穿上！" },
                        { "option_create_copy_radio", "创建Avatar模型副本并穿到副本上" },
                        { "option_delete_undo_tip", "这将删除选中的Avatar模型对象，删除后可以按\"CTRL + Z\"来撤回。" },
                        { "option_suffix_radio", "使用衣服名字作为骨骼名字后缀" },
                        ...
                        { "option_combine_physbone_tip", "启用该选项将会合并PhysBone为一个对象，它将会放在衣服对象下面。" },
                        ...
                        { "dialogue_animator_check_content", "这件衣服上有Animator组件，是否需要删除？" },
                ...
                },
                {
                    "English", new Dictionary<string, string>
                    {
                        ...
                        { "configure_clothes_label", "Clothes" },
                        { "configure_avatar_tip", "↑ Drag your avatar gameObject to here." },
                        { "configure_clothes_tip", "Drag your clothes gameObject to here ↑" },
                        { "configure_same_name_tip", "There is a same name clothes to your avatar. Are you sure you want dressing?" },
                        { "configure_sure_radio", "Sure!" },
                        { "configure_same_game_object_tip", "Avatar and Clothes are same gameObject!" },
                        { "configure_bone_name_issue_tip", "There is a problem with the bone name of the clothes!" },
                        { "configure_try_fix_button", "Try Fix" },
                        { "configure_armature_issue_tip", "Avatar or clothes armature is null. Check them name!" },
                        { "configure_armature_none_bone_tip", "Avatar or clothes armature child count is 0." },
                        { "configure_check_over_tip", "Clothes are all right! Dressing now!" },
                        ...
                        { "option_suffix_radio", "Use suffix by clothes name" },
                        ...
                        { "dialogue_animator_check_content", "This clothes contains Animator component, do you want to remove it?" },
